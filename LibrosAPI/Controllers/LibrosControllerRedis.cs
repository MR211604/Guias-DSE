...
[ApiController]
[Authorize]
public class LibrosControllerRedis : ControllerBase
{
    private readonly LibrosDbContext _context;
    private readonly IConnectionMultiplexer _redis;

    public LibrosControllerRedis(LibrosDbContext context, IConnectionMultiplexer redis)
    {
        _context = context;
        _redis = redis;
    }
    ...
    public async Task<ActionResult<Libro>> PostLibro(Libro libro)
    {
        ...
        {
            return BadRequest("El libro no tiene titulo");
        }
