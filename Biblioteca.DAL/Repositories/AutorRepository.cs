...
namespace Biblioteca.DAL.Repositories
{
    public class AutorRepository(IDatabaseRepository databaseRepository) : IAutorRepository
    {
        ...
        {
            var query = "SELECT * FROM Autores WHERE Id = @id";
        ...
        {
            var query = "UPDATE Autores SET Nombre = @Nombre, Apellido = @Apellido WHERE Id = @Id";
            var parameters = new DynamicParameters();
            ...
            {
                var query = "DELETE FROM Autores WHERE Id = @Id";
                var parameters = new DynamicParameters();
                parameters.Add("@Id", id);
